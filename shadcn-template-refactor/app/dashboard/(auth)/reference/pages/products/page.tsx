...
import ProductList from "@/app/dashboard/(auth)/reference/pages/products/product-list";
...
async function getProducts() {
  const data = await fs.readFile(
    path.join(process.cwd(), "app/dashboard/(auth)/reference/pages/products/data.json")
  );
  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center justify-between space-y-2">
        ...
        <Button asChild>
          <Link href="/dashboard/reference/pages/products/create">
