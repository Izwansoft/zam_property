...
import { NavDesktop } from "@/app/dashboard/(auth)/reference/apps/mail/components/nav-desktop";
import { NavMobile } from "@/app/dashboard/(auth)/reference/apps/mail/components/nav-mobile";
import { MailDisplayMobile } from "@/app/dashboard/(auth)/reference/apps/mail/components/mail-display-mobile";
