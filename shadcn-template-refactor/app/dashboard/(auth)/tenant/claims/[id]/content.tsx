// =============================================================================
// Tenant Claim Detail — Client content component
// =============================================================================
...
import { ClaimDisputePanel } from "@/modules/claim/components/claim-dispute-panel";
...
export function TenantClaimDetailContent() {
  ...
  if (error) {
    return (
      <div className="flex flex-1 flex-col gap-6 p-4 md:p-6">
        <PageHeader
          title="Claim Detail"
          backHref="/dashboard/tenant/claims"
        />
    ...
    <div className="flex flex-1 flex-col gap-6 p-4 md:p-6">
      <ClaimDetail
        ...
        disputeSlot={
          <ClaimDisputePanel
            claim={claim}
            onDisputeComplete={handleDisputeComplete}
          />
        }
      />
    </div>
