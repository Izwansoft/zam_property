...
┌─────────────────────────────────────────────────────────────┐
│                    API Integration                           │
│  Authenticated: GET /api/v1/search/listings                 │
│  Public (guest): GET /api/v1/public/search/listings         │
│  Suggestions:    GET /api/v1/search/suggestions             │
│                                                              │
│  NOTE: Public search page (app/(public)/search/)            │
│  must use /api/v1/public/search/listings (rate-limited,     │
│  no auth required). Dashboard search uses authenticated     │
│  /api/v1/search/listings endpoint.                          │
└─────────────────────────────────────────────────────────────┘
```
...
```typescript
// app/(public)/search/page.tsx — create this route for public search
...
import { SearchSortSelect } from '@/modules/search/components/search-sort-select';
import { SearchResultsSkeleton } from '@/modules/search/components/search-results-skeleton';
...
```typescript
// app/(public)/search/page.tsx — public search with SEO metadata
