// =============================================================================
// Vendor Maintenance Detail — Client content component
// =============================================================================
...
} from "@/modules/maintenance/components/owner-maintenance-detail";
import { useMaintenanceRealtime } from "@/lib/websocket/hooks/use-maintenance-realtime";
import { useAuth } from "@/modules/auth";

export function VendorMaintenanceDetailContent() {
    ...
    return (
      <div className="flex flex-1 flex-col gap-6 p-4 md:p-6">
        <PageHeader
          ...
          backHref="/dashboard/vendor/maintenance"
        />
