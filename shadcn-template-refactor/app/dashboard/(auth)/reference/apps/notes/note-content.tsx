...
import { AddNoteModal } from "@/app/dashboard/(auth)/reference/apps/notes/add-note-modal";
import { Note } from "@/app/dashboard/(auth)/reference/apps/notes/types";
import NoteListItem from "@/app/dashboard/(auth)/reference/apps/notes/note-list-item";
import { notes } from "@/app/dashboard/(auth)/reference/apps/notes/data";
import { NoteMobileSidebar } from "@/app/dashboard/(auth)/reference/apps/notes/note-sidebar";
