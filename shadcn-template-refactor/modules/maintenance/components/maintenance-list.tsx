// =============================================================================
// MaintenanceList â€” List component with filter tabs
// =============================================================================
...
import { MAINTENANCE_FILTER_TABS } from "../types";
...
interface MaintenanceListProps {
  ...
  /** Custom filter tabs (defaults to MAINTENANCE_FILTER_TABS) */
  filterTabs?: MaintenanceFilterTab[];
}
...
export function MaintenanceList({
  ...
  counts,
  filterTabs = MAINTENANCE_FILTER_TABS,
  ...
  }, [tickets, activeFilter, filterTabs]);
        ...
        <EmptyState
          ...
          description={
            activeFilter === "all"
              ...
              : `No ${activeFilter} maintenance requests found.`
          }
        />
      )}
