...
import { useStore } from "@/app/dashboard/(auth)/reference/apps/pos-system/store";

import { Card, CardContent, CardHeader, CardTitle } from "@/components/ui/card";
import CartListItem from "@/app/dashboard/(auth)/reference/apps/pos-system/components/cart-list-item";
