...
import Tasks from "@/app/dashboard/(auth)/reference/apps/todo-list-app/tasks";

async function getTasks() {
  const data = await fs.readFile(
    path.join(process.cwd(), "app/dashboard/(auth)/reference/apps/todo-list-app/data/tasks.json")
  );
