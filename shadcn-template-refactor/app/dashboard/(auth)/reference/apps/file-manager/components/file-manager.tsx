...
import FileManagerPagination from "@/app/dashboard/(auth)/reference/apps/file-manager/components/pagination";
...
export function FileManager() {
  ...
  const handleBreadcrumbClick = (index: number) => {
    if (index === -1) {
      router.push("/dashboard/reference/apps/file-manager");
    } else {
