...
import { Table, TableCategory } from "@/app/dashboard/(auth)/reference/apps/pos-system/store";

import { Button } from "@/components/ui/button";
import { RadioGroup, RadioGroupItem } from "@/components/ui/radio-group";
import { Tooltip, TooltipContent, TooltipProvider, TooltipTrigger } from "@/components/ui/tooltip";
import TableListItem from "@/app/dashboard/(auth)/reference/apps/pos-system/tables/components/table-list-item";
import AddTableDialog from "@/app/dashboard/(auth)/reference/apps/pos-system/tables/components/add-table-dialog";
                  ...
                  <Tooltip>
                    <TooltipTrigger>
                      <Button variant="outline" asChild>
                        <Link href="/dashboard/reference/apps/pos-system">
                          <ChevronLeft />
                        </Link>
                      </Button>
                    </TooltipTrigger>
