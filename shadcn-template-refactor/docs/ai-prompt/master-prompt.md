...
> **NOTE:** This project uses an existing shadcn UI kit template (`shadcn-template-refactor/`).
> Items marked ✅ EXIST in the template. Items marked 🆕 will be CREATED during development.

```
shadcn-template-refactor/
├── app/
│   ├── (public)/              # 🆕 Public pages (listing view, search) — no auth
│   ├── (auth)/                # 🆕 Auth pages (login, register, forgot-password) — guest only
│   ├── session-expired/       # 🆕 Session expired page
│   ├── forbidden/             # 🆕 403 Forbidden page
│   ├── dashboard/             # ✅ All authenticated portals + UI kit template
│   │   ├── (auth)/            # ✅ Protected portal routes (shared sidebar layout)
│   │   │   ├── layout.tsx     # ✅ Sidebar + header layout (from template)
│   │   │   ├── platform/      # ✅ Platform Admin Portal (stub page.tsx exists)
│   │   │   ├── tenant/        # ✅ Tenant Admin Portal (stub page.tsx exists)
│   │   │   ├── vendor/        # ✅ Vendor Portal (stub page.tsx exists)
│   │   │   ├── account/       # ✅ Customer Account Portal (stub page.tsx exists)
│   │   │   └── reference/     # ✅ UI kit reference pages (17+ sections)
│   │   └── (guest)/           # ✅ Template demo pages (login/register DESIGN REFERENCE)
│   ├── layout.tsx             # ✅ Root layout (ThemeProvider, fonts)
│   └── not-found.tsx          # ✅ 404 page
├── modules/                   # 🆕 Domain UI modules (to be created)
├── verticals/                 # 🆕 Vertical UI plugins (to be created)
├── components/                # ✅ Reusable UI (58+ shadcn components pre-installed)
│   ├── ui/                    # ✅ shadcn/ui primitives
│   └── layout/                # ✅ Template layout components (sidebar, header)
├── lib/                       # ✅ Partial — extend with api/, auth/, query/, errors/
├── hooks/                     # ✅ Template hooks (use-mobile, use-toast, etc.)
