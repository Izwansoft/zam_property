...
import ApiCallsCard from "@/app/dashboard/(auth)/reference/apps/api-keys/api-calls-card";
...
async function getApiKeys() {
  const data = await fs.readFile(
    path.join(process.cwd(), "app/dashboard/(auth)/reference/apps/api-keys/data.json")
  );
