...
This web app is a **ROLE-BASED MANAGEMENT DASHBOARD** for a:
...
- Vendor Dashboard
- (Optional) Support/Ops Dashboard

Phase 1 does NOT include:
- Public marketplace browsing UI
- SEO landing pages
- Consumer checkout flows (unless explicitly added later)
...
We will use **https://shadcnuikit.com/** dashboard template already downloaded.

Rules:
- Do NOT recreate or scaffold a new template
- Reuse the existing layout, components, and styling primitives
- Only adapt pages, routes, and components to match our domain modules
